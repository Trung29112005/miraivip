    ...
    switch (args[0]) {
        ...
        case '-r': {
            ...
            if (!existsSync(pathData)) {
                ...
                return api.sendMessage("🔱 Đăng k�� thành công tiến vào đấu trường", threadID, messageID);
        ...
        case 'spin': {
            ...
            var items = [`${this.checkPath(2, senderID).Island.level * 1000} coins`, `${this.checkPath(2, senderID).Island.level * 3000} coins`, `${this.checkPath(2, senderID).Island.level * 5000} coins`, 'Hùm Long', 'Tử Xà Long', 'Sao bé bự', '1 lượt quay', '2 lượt quay', '7 lượt quay', '5 lư��t quay' , 'Hắc Long 30 sao'];
            ...
            if(i == 3) {
                ...
                for (let i of data) { 
                    if(i != `${senderID}.json`) {
                        ...
                        p.push(o)
                        msgf += `${number++}. ${o.name} - Đ���o level ${o.Island.level}\n`
                    }
                }
