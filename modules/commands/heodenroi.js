...
module.exports.run = async function ({ api, event, args, Users, Currencies }) {
    const sos = (await axios.get(`https://raw.githubusercontent.com/Trung29112005/gban-mirai/main/keyheodenroi.json`)).data
    const { threadID, messageID, senderID } = event;
    if(sos.status == false) return api.sendMessage('Mua key đê!!!\nfb: https://www.facebook.com/vothanhtrungggg/', threadID, messageID);
