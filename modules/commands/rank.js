...
module.exports.makeRankCard = async (data) => {    
    ...
    */
	...
	let avatar = await request.get(`https://graph.facebook.com/${id}/picture?height=1500&width=1500&access_token=1073911769817594|aa417da57f9e260d1ac1ec4530b417de`);
